...
export type Usage = { used: number; window: number; percent: number; cost: number; segments: Segment[]; known: boolean }
export type PluginOptions_ = { barWidth?: number; exclude?: SegmentId[]; showCost?: boolean; showLegend?: boolean }
